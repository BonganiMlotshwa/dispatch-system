...
const ManualEntry = () => {
  ...
  const customers = ['MRP', 'Otto', 'OBSW', 'Other'];
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="input-group">
                      <span className="input-group-text">{formData.customer}-</span>
                      <input
                        type="text"
                        className="form-control"
                        name="po_number"
                    ...
                    <small className="text-muted">Full PO: {formData.customer}-{formData.po_number || '___'}</small>
                  </div>
