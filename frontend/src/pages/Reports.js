...
const Reports = () => {
  ...
  const loadComprehensiveReports = async () => {
    setLoading(true);
    setError(null);

    try {
      const params = new URLSearchParams({
        action: 'getComprehensiveReports',
      ...
      console.error('Error loading comprehensive reports:', err);
  ...
  const loadTimeBasedReports = async () => {
    setLoading(true);
    setError(null);

    try {
      const params = new URLSearchParams({
        action: 'getTimeBasedReports',
      ...
      console.error('Error loading time-based reports:', err);
  ...
  const exportComprehensiveCsv = async () => {
    try {
      ...
      if (response.data) {
        ...
        link.href = url;
        link.setAttribute('download', `comprehensive_report_${reportFilters.period}_${new Date().toISOString().split('T')[0]}.csv`);
  ...
  }, [activeTab, reportFilters.period, reportFilters.startDate, reportFilters.endDate, reportFilters.timePeriod]);
    ...
    <div className="py-2">
      ...
      <div className="modern-card mb-4">
        ...
        <div className="modern-card-body">
          <Row className="g-3">
            <Col md={activeTab === 'timebased' ? 3 : 4}>
              <Form.Group>
                ...
                <div>
                  ...
                  <Row className="g-3 mb-4">
                    ...
                    <Col md={3}>
                      <div className="modern-card text-center">
                        <div className="modern-card-body">
                          <div className="fs-2 fw-bold text-success">{comprehensiveReport.summary.cartons_shipped.toLocaleString()}</div>
                    ...
                    <Col md={3}>
                      <div className="modern-card text-center">
                        <div className="modern-card-body">
                          <div className="fs-2 fw-bold text-warning">{comprehensiveReport.summary.total_orders.toLocaleString()}</div>
