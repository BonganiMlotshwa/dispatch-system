...
import { Container, Row, Col, Card, Badge, Button, Alert, Form, Spinner, ProgressBar, InputGroup } from 'react-bootstrap';
            ...
            <DataTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  sortable: true,
                  cell: row => row.division || 'N/A'
                },
                {
                  name: 'Actions',
                  cell: row => (
                    <Link 
                      to={`/data-entry?barcode=${row.barcode_2d || row.barcode}`} 
              ...
              // Enable real-time filtering as user types
              fixedHeader
