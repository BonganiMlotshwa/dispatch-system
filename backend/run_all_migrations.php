...
$migrations = [
    'migrate_customer_support.php' => 'Customer Support (Otto, OBSW)',
    'migrate_truck_shipments.php' => 'Truck Shipments & Audit Trail',
    'migrate_employees.php' => 'Employee Management',
    'migrate_driver_workflow.php' => 'Driver Workflow Integration'
];
